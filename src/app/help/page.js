...
export default function HelpPage() {
  ...
  return (
    <div className="min-h-screen pb-8 bg-background text-foreground">
      <header className="sticky top-0 z-10 border-b border-border bg-surface/95 backdrop-blur-xl px-4 py-4">
        <div className="container-max flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="heading-1">Help &amp; Getting Started</h1>
          </div>
          <Link
            href={returnHref}
            className="btn-app"
      ...
      <main className="container-max mx-auto px-4 space-y-8 pt-8">
        <section className="section-card text-foreground">
          <p className="text-sm uppercase tracking-[0.3em] text-muted">Welcome</p>
          <h2 className="mt-3 heading-2">A simple beginner guide for Originly</h2>
        ...
        <section className="grid gap-6">
          <article className="glass-card rounded-[2rem] bg-surface p-8">
            <h3 className="heading-3">1. Sign in</h3>
          ...
          <article className="glass-card rounded-[2rem] bg-surface p-8">
            <h3 className="heading-3">2. Theme switcher</h3>
            <p className="mt-3 text-muted">
          ...
          <article className="glass-card rounded-[2rem] bg-surface p-8">
            <h3 className="heading-3">3. Capture your first idea</h3>
          ...
          <article className="glass-card rounded-[2rem] bg-surface p-8">
            <h3 className="heading-3">3. Verify idea integrity</h3>
            <p className="mt-3 text-muted">
          ...
          <article className="glass-card rounded-[2rem] bg-surface p-8">
            <h3 className="heading-3">4. Share and explore</h3>
            <p className="mt-3 text-muted">
          ...
          <article className="glass-card rounded-[2rem] bg-surface p-8">
            <h3 className="heading-3">5. Tips for beginners</h3>
            <ul className="mt-3 space-y-3 text-muted">
